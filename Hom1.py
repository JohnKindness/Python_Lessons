...
print(numbers)
print(f'Размер перой функции {sys.getsizeof(first())}')  # Размер первой функции
print(f'Размер второй функции {sys.getsizeof(second())}')  # Размер второй функции
print(f'Количество ссылок на первую фунцкию {sys.getrefcount(first())}')
print(f'Количество ссылок на вторую фунцкию {sys.getrefcount(second())}')
